...
object ConfigUtil {
   ...
   */
  def joinPath(elements: String*): String = ConfigImplUtil.joinPath(elements)
   ...
   */
  def joinPath(elements: List[String]): String = ConfigImplUtil.joinPath(elements)
   ...
   */
  def splitPath(path: String): List[String] = ConfigImplUtil.splitPath(path)
}
