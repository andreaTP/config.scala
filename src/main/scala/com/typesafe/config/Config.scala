...
trait Config extends ConfigMergeable {
   ...
   *         each leaf value.
   */
  def entrySet(): Set[Map.Entry[String, ConfigValue]]
   ...
   */
  def getAnyRefList(path: String): List[_ <: Any]
   ...
   */
  @Deprecated
  def getMillisecondsList(path: String): List[Long]
   ...
   */
  @Deprecated
  def getNanosecondsList(path: String): List[Long]
