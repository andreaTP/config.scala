...
object ConfigValueFactory {
   ...
   */
  def fromMap(values: Map[String, _ <: Any], originDescription: String): ConfigObject = {
   ...
   */
  def fromIterable(values: java.lang.Iterable[_ <: Any], originDescription: String): ConfigList = {
   ...
   */
  def fromMap(values: Map[String, _ <: Any]): ConfigObject = fromMap(values, null)
   ...
   */
  def fromIterable(values: java.lang.Iterable[_ <: Any]): ConfigList = fromIterable(values, null)
}
