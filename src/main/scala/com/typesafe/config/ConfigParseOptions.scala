...
object ConfigParseOptions {
   ...
   */
  def defaults(): ConfigParseOptions = {
    new ConfigParseOptions(null, null, true, null, null)
  }
}
 ...
 *
 */
class ConfigParseOptions private (val syntax: ConfigSyntax, 
  ...
  def setSyntax(syntax: ConfigSyntax): ConfigParseOptions = {
    if (this.syntax == syntax) this else new ConfigParseOptions(syntax, this.originDescription, this.allowMissing, 
  ...
  def setOriginDescription(originDescription: String): ConfigParseOptions = {
    if (this.originDescription == originDescription) this else if (this.originDescription != null && originDescription != null && 
      this.originDescription == originDescription) this else new ConfigParseOptions(this.syntax, originDescription, 
   ...
   */
  def withFallbackOriginDescription(originDescription: String): ConfigParseOptions = {
    if (this.originDescription == null) setOriginDescription(originDescription) else this
  }
  ...
  def setAllowMissing(allowMissing: Boolean): ConfigParseOptions = {
    if (this.allowMissing == allowMissing) this else new ConfigParseOptions(this.syntax, this.originDescription, 
  ...
  def setIncluder(includer: ConfigIncluder): ConfigParseOptions = {
    if (this.includer == includer) this else new ConfigParseOptions(this.syntax, this.originDescription, 
  ...
  def prependIncluder(includer: ConfigIncluder): ConfigParseOptions = {
    if (includer == null) throw new NullPointerException("null includer passed to prependIncluder")
    if (this.includer == includer) this else if (this.includer != null) setIncluder(includer.withFallback(this.includer)) else setIncluder(includer)
  }
  ...
  def appendIncluder(includer: ConfigIncluder): ConfigParseOptions = {
    if (includer == null) throw new NullPointerException("null includer passed to appendIncluder")
    if (this.includer == includer) this else if (this.includer != null) setIncluder(this.includer.withFallback(includer)) else setIncluder(includer)
  }
  ...
  def setClassLoader(loader: ClassLoader): ConfigParseOptions = {
    if (this.classLoader == loader) this else new ConfigParseOptions(this.syntax, this.originDescription, 
      this.allowMissing, this.includer, loader)
  }
  ...
  def getClassLoader(): ClassLoader = {
    if (this.classLoader == null) Thread.currentThread().getContextClassLoader else this.classLoader
  }
}
